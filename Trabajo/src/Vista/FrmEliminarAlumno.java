...
public class FrmEliminarAlumno extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        LblOpcion.setText("Eliminar Alumno");
        ...
        lblTexto.setText("Ingresa Código del alumno a eliminar:");
        ...
        btnEliminarAlumno.setBackground(new java.awt.Color(163, 156, 218));
        btnEliminarAlumno.setFont(new java.awt.Font("Carlito", 1, 36)); // NOI18N
        ...
        btnEliminarAlumno.setActionCommand("Buscar");
        btnEliminarAlumno.setAlignmentY(0.0F);
        btnEliminarAlumno.setBorder(null);
        btnEliminarAlumno.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnEliminarAlumno.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        ...
        PnlPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(PnlPrincipalLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnEliminarAlumno, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnEliminarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarAlumnoActionPerformed
        try {
            ...
            String dni=DataController.alumnoController.buscarAlumno(txtCajaCodigo.getText()).getDni();
            if (DataController.alumnoController.buscarAlumno(txtCajaCodigo.getText())!=null) {
                DataController.alumnoController.eliminarAlumno(dni);
                LogicTools.sendMessage("Alumno Eliminado Correctamente");
            ...
            LogicTools.sendMessage("Alumno no existente");
            setVisible(false);
        }
