...
public class FrmEditarAlumno extends javax.swing.JFrame {
    ...
    public FrmEditarAlumno(Alumno alumnoEditar) {
    ...
    private void loadInputs(){
        ...
        txtCajaCodigo.setText(alumnoEditar.getCod_alumno());
        txtCajaNombre.setText(alumnoEditar.getNombre());
        txtCajaApPaterno.setText(alumnoEditar.getAp_paterno());
        txtCajaApMaterno.setText(alumnoEditar.getAp_materno());
        txtCajaDNI.setText(alumnoEditar.getDni());
        txtObservaciones.setText(alumnoEditar.getObservacion());
        cmbNivel.setSelectedItem(alumnoEditar.getNivel_academico());
        cmbGrado.setSelectedItem(String.valueOf(alumnoEditar.getGrado()));
        cmbSeccion.setSelectedItem(alumnoEditar.getSeccion());
    }
    ...
    private void initComponents() {
        ...
        LblOpcion.setText("EDITAR ALUMNO");
                ...
                .addGroup(pnlPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlPrincipalLayout.createSequentialGroup()
                        .addGroup(pnlPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(lblObservaciones, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
                            .addGroup(pnlPrincipalLayout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addGroup(pnlPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(lblSeccion, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                        ...
                        .addGroup(pnlPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cmbNivel, 0, 160, Short.MAX_VALUE)
    ...
    private void btnAgregarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarAlumnoActionPerformed
        try{
            ...
            if (DataController.alumnoController.buscarAlumno(dni)!=null) {
                ...
                DataController.alumnoController.editarAlumno(alumnoEditar,alumno);
                LogicTools.sendMessage("Alumno editado correctamente :D");
                limpiarCajas();
